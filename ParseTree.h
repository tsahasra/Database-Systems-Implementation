...
struct InsertOperation {
	...
	// this is the name of the file to be inserted into table tname
	char *fname;

	// this is the name of the table into which the records in file fname have to be inserted in
	char *tname;
};


struct CreateAttList {
	// this is the name of the attribute 
	char *name;

	// this tells us the type of the attribute: FLOAT, INT, STRING..
	int code;

	struct CreateAttList *next;
};
